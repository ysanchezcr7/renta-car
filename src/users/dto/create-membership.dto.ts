...
export class CreateOwnerMembershipDto {
	...
	@ApiProperty({
		description: 'Monto fijo de la membresía (requerido solo para STRIPE, ignorado para APPLE_IAP)',
		example: 29.99,
		required: false,
	})
	@ValidateIf((o: { paymentMethod?: PaymentMethodType }) => !o.paymentMethod || o.paymentMethod === PaymentMethodType.STRIPE)
